...
router.get("/environments", function (req, res) {
    request.get('http://xaptools.bn1.binginternal.com/MetricUX/Data/GetEnvironments',
...
router.get("/machines", function (req, res) {
    request.get('http://xaptools.bn1.binginternal.com/MetricUX/Data/UpdateMachineList?environment='+req.query.environment,
        function (error, response, body) { res.json(JSON.parse(body)) });
});

router.post("/info", function (req, res) {
    request.post('http://xaptools.bn1.binginternal.com/MetricUX/Data/GetJSON',
